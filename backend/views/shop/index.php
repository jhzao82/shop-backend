            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            <a href="/shop"><i class="fa fa-table fa-fw"></i> 商家管理<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active" href="/shop">商家管理</a>
                                </li>
                                <li>
                                    <a href="/category?CategorySearch[level]=1">分类管理</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="/category?CategorySearch[level]=2">分类管理</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="/user"><i class="fa fa-sitemap fa-fw"></i> 会员管理</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
...
<p><?= Html::a('添加商家', ['create'], ['class' => 'btn btn-success']) ?></p>
<?= GridView::widget([
